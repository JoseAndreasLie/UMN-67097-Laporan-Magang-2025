...
% \section*{Lampiran 5. Form Bimbingan}
\begin{center}
    \frame{\includegraphics[width=\textwidth,page=1]{assets/pdf/TURNITIN_JoseAndreasLie_V2.pdf}}
\end{center}
\clearpage
\begin{center}
    \frame{\includegraphics[width=\textwidth,page=2]{assets/pdf/TURNITIN_JoseAndreasLie_V2.pdf}}
\end{center}
\clearpage
\begin{center}
    \frame{\includegraphics[width=\textwidth,page=3]{assets/pdf/TURNITIN_JoseAndreasLie_V2.pdf}}
\end{center}
\clearpage
\begin{center}
    \frame{\includegraphics[width=\textwidth,page=4]{assets/pdf/TURNITIN_JoseAndreasLie_V2.pdf}}
\end{center}
\clearpage
