...
% 
% Judul laporan. 
\var{\judul}{Rancang Bangun Fitur Sistem Manajemen Cuti dan Strukturisasi Hierarki Pada Aplikasi CHRIS di PT Ganda Visi Jayatama}
% Judul Pendek (Tiga Kata Pertama). 
\var{\judulPendek}{Rancang Bangun Fitur}
% 
